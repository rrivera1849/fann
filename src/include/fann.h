...
/* Function: fann_randomize_weights_normalize_variance
  Give each connection a random weight and then normalize the variance of each
  neuron's output to 1 by scaling its weight vector by the square-root of its fann-in.
